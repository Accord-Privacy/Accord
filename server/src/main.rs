...
use clap::Parser;
use handlers::{
    add_reaction_handler, auth_handler, ban_check_handler, ban_user_handler,
    create_channel_category_handler, create_dm_channel_handler, create_invite_handler,
    create_node_handler, delete_channel_category_handler, delete_channel_handler,
    delete_file_handler, delete_message_handler, deregister_push_token_handler,
    download_file_handler, edit_message_handler, fetch_key_bundle_handler,
    get_channel_messages_handler, get_dm_channels_handler, get_message_reactions_handler,
    ...
    list_invites_handler, pin_message_handler, publish_key_bundle_handler, register_handler,
    register_push_token_handler, remove_reaction_handler, revoke_invite_handler,
    search_messages_handler, set_node_user_profile_handler, store_prekey_message_handler,
