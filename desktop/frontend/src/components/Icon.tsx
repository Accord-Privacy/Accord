...
const icons: Record<string, string> = {
  ...
  'bell-off': 'M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.63-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.64 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2zM3.27 3L2 4.27l2.9 2.9C4.33 8.29 4 9.6 4 11v5l-2 2v1h14.73l1 1L19.73 21 21 19.73 3.27 3z',
  screen: 'M21 3H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v2H8v2h8v-2h-2v-2h7c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 14H3V5h18v12z',
  'screen-share': 'M21 3H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v2H8v2h8v-2h-2v-2h7c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 14H3V5h18v12zm-5.5-7.5l-3 3.5-2-2.5L8 14h8l-2.5-4.5z',
  'screen-off': 'M21 5v12c0 .34-.09.66-.23.94L3.79 1H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v2H8v2h8v-2h-2v-2h3.73L1 4.27 2.27 3 21 21.73 22.73 20 21.23 18.5c.48-.28.77-.82.77-1.5V5c0-1.1-.9-2-2-2h-1.18l-2 2H21zM3 17V5h.18l12 12H3z',
};
